...
const ENDPOINTS = {
  // DASHBOARD
  DASHBOARD_SUMMARY: `${API_HOST}/api/admin/dashboard/summary`,
  ACCESS_CHART: `${API_HOST}/api/admin/dashboard/accesschart`,

  // MEMBERSHIP
  PENDING_REQUESTS: `${API_HOST}/api/admin/memberships/pending`,
  APPROVED_RESIDENTS: `${API_HOST}/api/admin/residents/approved`,
  APPROVE_REQUEST: (id) => `${API_HOST}/api/admin/memberships/approve/${id}`,
  REJECT_REQUEST: (id) => `${API_HOST}/api/admin/memberships/reject/${id}`,
  DELETE_REQUEST: (id) => `${API_HOST}/api/admin/memberships/delete/${id}`,
  SUBMIT_REQUEST: `${API_HOST}/api/admin/memberships`,

  // RESIDENTS
  ALL_RESIDENTS: `${API_HOST}/api/admin/residents`,
