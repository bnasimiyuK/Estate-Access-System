...
async function membershipFormSubmitHandler(e) {
    ...
    const courtId = courtDropdown.value;   // send CourtID
    ...
    try {
        const result = await apiFetch("/api/admin/membership", {
            method: "POST",
            body: JSON.stringify(submissionBody)
        });

        displayMessage(`Membership submitted successfully! Request created.`, "success");
