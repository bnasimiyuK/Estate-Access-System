  ...
  try {
    ...
    for (const v of visitors) {
      await pool.request()
        ...
        .input("NationalID", sql.NVarChar(50), v.NationalID)
        .input("PhoneNumber", sql.NVarChar(20), v.PhoneNumber)
        .input("VehicleNumber", sql.NVarChar(20), v.VehicleNumber || null)
        .input("Purpose", sql.NVarChar(200), v.Purpose)
        .input("DateOfVisit", sql.Date, v.DateOfVisit)
        .query(`
