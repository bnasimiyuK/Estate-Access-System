...
// 3. AUTHENTICATION (Apply globally, except for public routes like /api/auth)
// NOTE: Public routes must be defined BEFORE this middleware if it's applied globally.
// If you want all routes *except* M-Pesa callback and auth to be protected, 
// you would apply authenticateJWT inside the router definitions instead. 
// We leave it here based on your previous structure, but be aware of the impact.
// app.use(authenticateJWT); // Moved below M-Pesa Callback for safety
