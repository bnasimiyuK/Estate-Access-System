...
const ENDPOINTS = {
    ...
    // Membership Requests
    membershipRequests: `${API_HOST}/api/admin/memberships`,

    // Residents
    residents: `${API_HOST}/api/admin/residents`,

    // Access Logs
    accessLogs: `${API_HOST}/api/admin/accesslogs`,

    // Payments
    payments: `${API_HOST}/api/admin/payments`,

    // Gate Overrides
    overrides: `${API_HOST}/api/admin/overrides`,

    // Visitors
    visitors: `${API_HOST}/api/admin/visitors`
};
