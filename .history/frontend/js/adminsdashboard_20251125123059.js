...
// ================================
// UTILITIES (Functions called by main logic)
...
// ================================
// DASHBOARD FUNCTIONS (MOVED HERE TO FIX REFERENCE ERROR)
// These functions must be defined before loadPageIntoMainContent calls them.
...
async function loadAccessChart() {
  try {
    ...
    // Assuming 'Chart' is globally available (e.g., loaded via CDN like Chart.js)
...
async function loadPageIntoMainContent(url) {
  ...
  try {
    ...
    if (url.includes("dashboardoverview.html")) {
      // ✅ FIX IS HERE: loadDashboardSummary is now defined above this line.
