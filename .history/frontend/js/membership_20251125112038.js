...
// ✅ FIX: Use separate constants for key vs. token value
...
const courtDropdown = document.getElementById("courtDropdown"); // Must match HTML
...
async function membershipFormSubmitHandler(e) {
    ...
    try {
        const res = await fetch(`${API_HOST}/api/admin/membership/request`, {
            method: "POST",
            headers: {
